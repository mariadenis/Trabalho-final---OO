...
class DataRecord():
    ...
    def read(self):
        try:
            ...
            # Caso o arquivo não exista, cria um usuário padrão 'Guest'
            self.__user_accounts.append(UserAccount('Guest', '010101','101010'))

    def book(self, username, password):
        """Cria um novo usuário e grava no banco de dados"""
    ...
    def getCurrentUser(self, session_id):
        """Retorna o usuário autenticado baseado no session_id"""
    ...
    def getUserName(self, session_id):
        """Retorna o nome de usuário do session_id"""
        if session_id in self.__authenticated_users:
    ...
    def getUserSessionId(self, username):
        """Obtém o session_id de um usuário com base no nome de usuário"""
    ...
    def checkUser(self, username, password):
        """Verifica as credenciais do usuário e retorna o session_id se for válido"""
        ...
        return None  # Retorna None se o usuário não for autenticado

    def logout(self, session_id):
        """Desloga o usuário, removendo seu session_id"""
        if session_id in self.__authenticated_users:
